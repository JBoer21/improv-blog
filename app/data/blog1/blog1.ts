...
const par10 = `The first is rule 95: Let go of your great idea`;

const par11 = `Ironically, I think this really enforces the ideas I mentioned before, about how it is difficult to drop your intuition and just build off of what the person before you is saying. This idea is clearly important for improv, but also for real life. Being a good listener is not only about hearing what is being said, but also choosing to drop your own intuitions and desire to do things in your own way. In day-to-day life, I hope to adopt this rule. I think the impact it has will have is clear: it will make me a more empathetic listener and better friend/teammate.`;

const par12 = `The second rule is rule 79: Be boring`;

const par13 = `Another new thing I learnt so far in class is that trying to be funny is never actually funny. In improv, hilarity happens naturally – it is a product of the art. This is something I tend to struggle with. I love humorous jabs and invocations and quite honestly probably try to use them too much. In the context of improv, trying to be funny handicaps the scene. It limits creativity and the ability to build one idea into a larger one. Being boring in improv is something that I really want to follow.`;

const par14 = `This rule, of course, also applies to real life. Too many humorous injections can sometimes come across as facetious. Sometimes, it is better to just be boring and allow dialogs and conversations to be built. The impact of this rule is simply that, by forcing less funniness, you are more able to get into the meat of the topic at hand.`;

const par15 = `Here is a video of Jason Mantzoukas explaining the importance of rule 79:`;
