...
const par2 = `Another intuition that I gathered from watching was that being on the other side of things and actually doing the improv would be easy. In lots of cases, from the outside looking in, it feels like you can just say or do whatever you want. Shouldn’t be too hard, right? I am here to share that after the first two weeks of class and actually being on the other side of the audience, all of my ideas about improv have been challenged greatly. Improv is not easy at all. `;
...
const par17 = `Overall, I have been really enjoying this class and learning a lot from it. I have been able to apply some of the skills I have learned to my everyday life, and I am excited to see where things go!`;
